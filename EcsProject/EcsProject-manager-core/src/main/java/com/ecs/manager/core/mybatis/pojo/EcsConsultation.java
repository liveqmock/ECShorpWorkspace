...
public class EcsConsultation extends BaseObject implements Serializable {
    private Long id;
    ...
    public boolean equals(Object that) {
        ...
        EcsConsultation other = (EcsConsultation) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getForConsultation() == null ? other.getForConsultation() == null : this.getForConsultation().equals(other.getForConsultation()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getForConsultation() == null) ? 0 : getForConsultation().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", forConsultation=").append(forConsultation);
