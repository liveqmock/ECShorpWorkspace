package com.ecs.manager.core.admin.constant;
...
public final class ErrConstants {
    ...
    public final static String GENERAL_LOGINOUT_MSG = "用户还未登录";
    public final static String GENERAL_LOGINOUT_CODE = "000000";
