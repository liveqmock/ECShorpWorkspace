...
<table class="adminMain_top">
	<tbody>
		<tr>
			<td class="td01"></td>
			<td class="td02">
			<h3 class="topTitle fb f14">添加用户组</h3>
			</td>
			<td class="td03"></td>
		</tr>
	</tbody>
...
<div class="adminMain_wrap">
	...
	<div class="adminContent clearfix">
		<table width="100%" class="table_bg05">
			<tr>
				<th colspan="2" class="thTitle" scope="row"><span class="cBlue f14 fb pl20">添加用户组</span></th>
			</tr>
			<tr>
				<th class="thList" scope="row"><span class="red">*</span>用户组名称：</th>
				<td class="tdBox">
				    <input type="hidden" name="user_usergroup" id="user_usergroup"/>
					<input type="text" name="userGroupName" id="userGroupName" value="" style="width:300px;"/>
			...
			<tr>
				...
				<td class="tdBox">
					<textarea id="userGroupDesc" name="userGroupDesc" style="width:300px;height:100px;"></textarea>
				</td>
			</tr>
			<tr>
				...
				<td class="tdBox">
					  <#if userlist??>
                            <#list userlist as user>
                               <input type="checkbox" value="${user.id!''}"/><label>&nbsp;${user.username}&nbsp;</label>
                            </#list>
                      </#if>      
				</td>
			</tr>
...
<script type="text/javascript">
    ...
    //用Ajax提交信息
	function checkInfo(){
	    var params=$("#addUserGroupForm").serialize();
	    $.ajax({
					type : "POST",
					url : "${rc.getContextPath()}/usergroup/save?format=json",
					data : params,
	                dataType: "text",
