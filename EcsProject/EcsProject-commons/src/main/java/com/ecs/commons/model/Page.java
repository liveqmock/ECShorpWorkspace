...
public class Page<T> {
    ...
    public String toString() {
        return "Page [pageNo=" + pageNo + ", pageSize=" + pageSize + ", totalCount=" + totalCount + ", totalPages="
                + totalPages + ", morePage=" + morePage + ", preMorePage=" + preMorePage + ", showMinPage="
                + showMinPage + ", showMaxPage=" + showMaxPage + ", result=" + result + ", isHasNext=" + isHasNext
                + ", isHasPre=" + isHasPre + ", firstRecord=" + firstRecord + ", endRecord=" + endRecord + "]";
    }
